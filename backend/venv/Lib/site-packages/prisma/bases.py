...
class BaseRepository(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Repository']] = 'Repository'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.RepositoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.RepositoryActions[_PrismaModelT](client or get_client(), cls)
