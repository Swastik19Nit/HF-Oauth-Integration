...
SCHEMA_PATH = Path('D:/HF/backend/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    repository: 'actions.RepositoryActions[models.Repository]'
    ...
    def __init__(
        ...
        *,
        ...
        self.repository = actions.RepositoryActions[models.Repository](self, models.Repository)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'D:/HF/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    repository: 'RepositoryBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.repository = RepositoryBatchActions(self)
